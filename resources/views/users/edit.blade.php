    ...
    <div class="w-full h-screen bg-myBg flex items-center tablet:px-5 ">
        ...
        <div class="w-full lg:w-2/4 xl:w-2/5 flex flex-col mx-auto bg-medium rounded-3xl  shadow-3xl p-10">
            ...
            <div
                ...
                <h1 class="text-4xl phone:text-2xl font-bold  text-white">Edit User</h1>
            </div>



            <form action="{{route('users.update', $user->id)}}" method="post" class="flex flex-col text-white mt-5 w-full mx-auto">
                @csrf
                @method('put')
                ...
                <input type="text" name="role" id="role" 
                    ...
                    value="@if($user->role == "admin")admin
                            @elseif($user->role == "mahasiswa")mahasiswa
                            @elseif($user->role == "super")super
                            @endif"
                    disabled>
