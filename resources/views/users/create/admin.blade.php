...
@section('container')
    <div class="w-full h-screen bg-myBg flex items-center tablet:px-5 ">
        ...
        <div class="w-full h-20 bg-primary flex items-center justify-between p-5 text-white md:hidden">

            <a href="/admin/dahsboard" class="w-10 h-10 bg-white rounded-full">home</a>
            <div
        ...
        <div class="w-full lg:w-2/4 xl:w-2/5 flex flex-col mx-auto bg-medium rounded-3xl  shadow-3xl p-10">
            ...
            <div
                ...
                <h1 class="text-4xl phone:text-2xl font-bold  text-white">Tambah User Admin</h1>
            </div>
            ...
            <form action="{{route('users.store')}}" method="post" class="flex flex-col text-white mt-5 w-full mx-auto">
                ...
                <label for="admin_id" class="mb-2">NIP :</label>
