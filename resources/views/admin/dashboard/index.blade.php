...
@section('container')
    <div class="w-full h-auto xxl:h-screen bg-myBg flex xxl:items-center  font-poppins laptop:flex-col">
        ...
        <div class="w-full xl:flex xxl:items-center z-10 mt-10 xxl:mt-0">

            <div
                class="xl:w-3/5 xxl:w-3/4 xxl:h-90% flex flex-col items-center phone:w-full phone:p-5 px-10">
                ...
                <div
                    ...
                    <div
                        class="phone:h-56  bg-medium text-slate-400 rounded-3xl text-center shadow-3xl flex flex-col justify-between  p-8 lg:w-45% md:w-full laptop:px-12 phone:p-4 xxl:w-1/3 xxl:h-80">
                        <h1 class="text-2xl font-bold "> Siswa Magang</h1>
                        <div class="w-full flex items-center justify-around ">
                            <iconify-icon icon="bi:people-fill"
                                class="phone:text-7xl font-extrabold text-red-600 text-9xl "></iconify-icon>
                            <div>
                                <div class="text-center">
                                    <h1 class="phone:text-4xl font-extrabold text-5xl">{{ $jmlMahasiswa }}</h1>
                                    <p class="phone:text-md text-lg">Orang</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        class=" bg-medium text-slate-400 rounded-3xl text-center shadow-3xl flex flex-col justify-between phone:h-56 md:w-full lg:w-45% p-8 laptop:px-12 laptop:mt-10 phone:p-4 xxl:w-1/3 xxl:mx-5 xxl:h-80">
                        <h1 class="text-2xl font-bold "> Permintaan</h1>
                        <div class="w-full flex items-center justify-around ">
                            <iconify-icon icon="subway:massage-1"
                                class="text-9xl font-extrabold text-green-600 phone:text-7xl"></iconify-icon>
                            <div>
                                <div class="text-center">
                                    <h1 class="text-5xl font-extrabold phone:text-4xl ">{{ $jmlPermintaan }}</h1>
                                    <p class="text-lg">Permintaan</p>
                                </div>
                            </div>
                        </div>
                        <a href="/admin/permintaan-magang"
                            class="mt-5 px-5 py-2 text-white text-lg bg-green-600 rounded-full font-bold shadow-3xl hover:bg-transparent hover:border-green-600 hover:border-2 hover:text-green-600 hover:scale-107  transition duration-200 ease-in-out">
                            Detail
                        </a>
                    </div>

                    <div
                        class=" bg-medium text-slate-400 rounded-3xl text-center shadow-3xl flex flex-col justify-between extra:w-full p-8 extra:mt-10 laptop:px-12 phone:p-4 phone:h-56 xl:w-1/3 xxl:w-1/3 xxl:h-80">
                        ...
                        <div class="w-full flex items-center justify-around ">
                            ...
                            <div>
                                <div class="text-center">
                                    <h1 class="text-5xl font-extrabold phone:text-4xl ">{{ $jmlAbsen }}</h1>
                                    <p class="text-lg phone:-text-sm">Absen</p>
                                </div>
                            </div>
                        </div>
                        <a href="/admin/absensi/absen-today"
            ...
            <div class=" xl:w-2/5 flex-col flex h-250  justify-between p-5 animate__animated animate__fadeInRight">
                ...
                <div class="flex flex-col mt-5 w-full bg-medium h-64 rounded-3xl shadow-3xl items-center">
                    <div
                        ...
                        <a href="{{route('profile.index')}}" class=" bg-white text-primary px-6 py-2 rounded-full shadow-3xl hover-white">Detail</a>
                    ...
                    <div class="flex w-11/12 mx-auto h-full items-center">
                            ...
                            class=" w-24 h-24 tablet:w-16 tablet:h-16 rounded-full object-cover object-center mr-4">
                        @else
