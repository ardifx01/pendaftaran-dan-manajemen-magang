    ...
    <nav class="w-28 h-250 bg-primary rounded-full flex flex-col items-center mx-auto justify-between py-5 shadow-3xl">
        ...
        <ul class="mx-auto panel w-20 h-128 flex flex-col text-center justify-around text-white text-lg">
            <li class="relative group ">
                <a href="{{ url('/mahasiswa/dashboard') }}" class="flex flex-col items-center justify-center transition transform duration-300 hover:scale-105">
                    <iconify-icon icon="material-symbols:dashboard" class="{{ Request::is('mahasiswa/dashboard') ? 'active' : '' }} text-4xl"></iconify-icon>
            ...
            <li class="relative group">
                <a href="{{ url('/mahasiswa/absensi-mahasiswa') }}" class="flex flex-col items-center justify-center transition transform duration-300 hover:scale-105">
                    <iconify-icon icon="mdi:calendar-check-outline" class="{{ Request::is('mahasiswa/absensi-mahasiswa*') ? 'active' : '' }} text-4xl"></iconify-icon>
            ...
            <li class="relative group ">
                <a href="{{ url('/mahasiswa/jurnal') }}" class="flex flex-col items-center justify-center transition transform duration-300 hover:scale-105">
                    <iconify-icon icon="mdi:user-check" class="{{ Request::is('mahasiswa/jurnal*') ? 'active' : '' }} text-4xl"></iconify-icon>
                    <span class="opacity-0 group-hover:opacity-100 absolute left-full top-1/2 transform -translate-y-1/2 bg-white text-primary px-4 py-2 rounded-full text-lg whitespace-nowrap">Jurnal</span>
                </a>
            </li>
        </ul>
